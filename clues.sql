...
SELECT country, region, population  FROM country WHERE REGION = 'Southern Europe' ORDER BY population;
Vatican (VAT)
...
carmen=# \d country
carmen=# SELECT country FROM country where code='SMR';
...
Outputs "Santa Monica! GOTCHA CARMEN! You're gonna be spending some quality time behind bars! ha ha ha"
